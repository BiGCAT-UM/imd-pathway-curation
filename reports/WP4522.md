...
```
https://identifiers.org/wikipathways/WP4522 has an metabolite not linked to an interaction: IDL
https://identifiers.org/wikipathways/WP4522 has an metabolite not linked to an interaction: LDL
https://identifiers.org/wikipathways/WP4522 has an metabolite not linked to an interaction: Cyclic fatty acids
```
